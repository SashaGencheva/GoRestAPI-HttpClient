...
public class UpdateUserTest extends BaseRequest {
    ...
    @Test
    public void updateUser() throws IOException, ProtocolException {
        faker = new Faker();
        ...
        if ((user.getName() != null) && (user.getEmail() != null) && (user.getGender() != null) && (user.getStatus() != null)) {
            ...
            Assert.assertEquals(actualId, expectedId, "Expected and actual updated user id do not match");
